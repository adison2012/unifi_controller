...
script_logo() {
  ...
  _                                      _____ _     _      _     _ 
 | |                                    / ____| |   (_)    | |   | |
 | |     ___ _ __ ___   ___  _ __ _____| (___ | |__  _  ___| | __| |
 | |    / _ \ '_ ` _ \ / _ \| '_ \______\___ \| '_ \| |/ _ \ |/ _` |
 | |___|  __/ | | | | | (_) | | | |     ____) | | | | |  __/ | (_| |
 |______\___|_| |_| |_|\___/|_| |_|    |_____/|_| |_|_|\___|_|\__,_|
...
help_script() {
  ...
  echo -e "    Easy UniFi Network Install script assistance\\n"
  echo -e "
  Script usage:
  bash $0 [options]
...
script_option_list=(-skip --skip --custom-url --v6 --ipv6 --email --mail --fqdn --domain-name --server-ip --server-address --external-dns --force-renew --renew --dns --dns-challenge --help)
